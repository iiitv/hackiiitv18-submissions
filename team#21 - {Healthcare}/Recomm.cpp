...
void Recomm()
{
    ...
    if(sum>=0 && sum<10) 
    {
        cout<<"\nHallelujah! You are living the happiest life you can. There may be ups and downs which are considered normal behaviour. Keep yourself engaged in doing things you love and";
        cout<<"\nnever let that smile of yours fade away. :-). ";
    }
    else if(sum>=10 && sum<18)
    {
        cout<<"\nYou are normally a cheerful person but may be susceptible to mild mood disturbances. These may be due to adolescence. Cultivating a hobby would do wonders in getting away";
        cout<<"\nfrom the negativities in life.";
    }
    else if(sum>=18 && sum<22)
    {
        cout<<"\nYou contemplate a lot. Which is good for a healthy mind but overthinking over an event may make you feel low at times. Live in the moment and don't delve deep on issuesbof the";
